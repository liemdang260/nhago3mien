...
const mostViewedNews = [
    { id: 1, title: 'Mẫu nhà gỗ đẹp', imgLink: 'https://nhagoanphu.com/image/cache/catalog/mau-nha-go/nha-tho-tu-duong/NTD-01/nha-tu-duong-2-400x300.jpg', createAt: '16/10/2018', views: 16903 },
    { id: 2, title: 'Nhà gỗ anphuco', imgLink: 'https://nhagoanphu.com/image/cache/catalog/mau-nha-go/Nha-go-hien-dai/NGHD-12/nha-vuon-bang-go-3-400x300.jpg', createAt: '18/10/2018', views: 15309 },
    { id: 3, title: 'Bản vẽ thiết kế nhà gỗ lục giác', imgLink: 'https://nhagoanphu.com/image/cache/catalog/mau-nha-go/nha-tho-tu-duong/NTD-01/nha-tu-duong-2-400x300.jpg', createAt: '16/10/2018', views: 16903 },
    { id: 4, title: 'Đặc điểm chung của nhà gỗ lục giác', imgLink: 'https://nhagoanphu.com/image/cache/catalog/mau-nha-go/nha-tho-tu-duong/NTD-01/nha-tu-duong-2-400x300.jpg', createAt: '16/10/2018', views: 16903 },
    {
        id: 5, title: 'Báo giá thiết kế nhà thờ họ',
        imgLink: 'https://nhagoanphu.com/image/cache/catalog/mau-nha-go/nha-tho-tu-duong/NTD-01/nha-tu-duong-2-400x300.jpg', createAt: '16/10/2018', views: 16903
    },
]
        ...
        <div>
            <ViewList title={"XEM NHIỀU NHẤT"}>
                <ul className="border-[1px] border-gray-300">
                    {
                        mostViewedNews && mostViewedNews.map((item, index) => (
                            <li key={index}><MostViewedItem item={item} /></li>
                        ))
                    }
                </ul>
            </ViewList>
