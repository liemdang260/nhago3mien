        ...
        <div className='relative'>
            <div className='relative md:absolute mb-2 md:mb-0 w-1/2 z-10 left-1/2 -translate-x-1/2 md:w-3/6 h-[400px]  md:flex md:justify-center lg:h-[calc(100vh_-_280px)]'>
                <div className='absolute w-full h-[calc(100vh_-_380px)] self-center flex'>
                    <div className='skew-x-6 -translate-x-1/2 md:translate-x-0 h-96 bg-black/40 grow md:translate-y-1/2 md:h-1/2 lg:h-full lg:translate-y-0'></div>
                    <div className='-skew-x-6 translate-x-1/2 md:translate-x-0 h-96 bg-black/40 grow md:translate-y-1/2 md:h-1/2 lg:h-full lg:translate-y-0'></div>
                </div>
                <div className='absolute w-full md:w-3/4 h-[calc(100vh_-_330px)] self-center flex'>
                    <div className='skew-x-3 -translate-x-1/4 md:translate-x-0 h-96 bg-black/40 grow md:translate-y-1/2 md:h-1/2 lg:h-full lg:translate-y-0'></div>
                    <div className='-skew-x-3 translate-x-1/4 md:translate-x-0 h-96 bg-black/40 grow md:translate-y-1/2 md:h-1/2 lg:h-full lg:translate-y-0'></div>
                </div>
                <video
                    autoPlay={true}
